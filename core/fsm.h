 ...
 */
typedef struct {
    size_t id;                          ///< Unique identifier for the vertex
 ...
 */
typedef struct {
    size_t id;                          ///< Unique identifier for the edge
    size_t from_vertex_id;              ///< Source vertex ID
    size_t to_vertex_id;                ///< Destination vertex ID
    ...
    bool is_self_loop;                  ///< Flag indicating if this is a self-loop
} edge_t;
...
typedef struct {
    ...
    size_t vertex_count;                ///< Current number of vertices
    size_t edge_count;                  ///< Current number of edges
    size_t vertex_capacity;             ///< Allocated capacity for vertices array
    size_t edge_capacity;               ///< Allocated capacity for edges array
    size_t next_vertex_id;              ///< Next available vertex ID
    size_t next_edge_id;                ///< Next available edge ID
} fsm_t;
